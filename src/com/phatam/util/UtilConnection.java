...
public class UtilConnection {
	...
	public static String getConnectivityStatusString(Context context) {
		int conn = UtilConnection.getConnectivityStatus(context);
		String status = null;
		if (conn == UtilConnection.TYPE_WIFI) {
			status = "Wifi enabled";
		} else if (conn == UtilConnection.TYPE_MOBILE) {
			status = "Mobile data enabled";
		} else if (conn == UtilConnection.TYPE_NOT_CONNECTED) {
