...
public class ViewFourVideosCategoryPreview extends LinearLayout implements OnClickListener {

	private Context mContext;
	public static String CLASS_PATH = ViewFourVideosCategoryPreview.class.toString();
	...
	public ViewFourVideosCategoryPreview(Context context) {
		super(context);
	}

	public ViewFourVideosCategoryPreview(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.view_four_videos_preview, this);
