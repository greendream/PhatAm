...
public class FRelativeVideoListView extends SherlockFragment {
	private ArrayList<MVideoItem> mRelativeVideos;
	...
	public FRelativeVideoListView() {
	}

	public FRelativeVideoListView(MVideoItem videoItem) {
