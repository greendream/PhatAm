...
@SuppressLint("NewApi")
public class FIntroduce extends SherlockFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		((TextView) rootView.findViewById(R.id.tvIntro)).setText(Html.fromHtml(UtilApplication.loadStringFromAssetFile("PhatAmIntroduce.html", getActivity())));
		return rootView;
	}
