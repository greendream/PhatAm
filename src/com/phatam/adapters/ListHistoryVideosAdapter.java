...
public class ListHistoryVideosAdapter extends ArrayAdapter<MVideoSavedItem> {
	...
	public ListHistoryVideosAdapter(Activity activity, ArrayList<MVideoSavedItem> list_model) {
