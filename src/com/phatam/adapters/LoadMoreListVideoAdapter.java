...
public class LoadMoreListVideoAdapter extends ArrayAdapter<MVideoItem> {
	...
	public LoadMoreListVideoAdapter(Activity activity, ArrayList<MVideoItem> list_model) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GlobalData.imageLoader.displayImage(mListVideoModel.get(position).getYoutubeThumb(),
